<script src="<?php echo url('vendor/js/jquery.js')?>"></script>
<script src="<?php echo url('vendor/js/popper.js')?>"></script>
<script src="<?php echo url('vendor/js/bootstrap.bundle.min.js')?>"></script>
<script src="<?php echo url('vendor/js/bootstrap.js')?>"></script>
<script src="<?php echo url('vendor/js/owl.carousel.min.js')?>"></script>
<script src="<?php echo url('vendor/js/owl.js')?>"></script>
<script src="<?php echo url('vendor/js/snackbar.min.js')?>"></script>
