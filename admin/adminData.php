...
//   include 'session.php';
  ...
  if(isset($_SESSION['adminId'])){ 
    ...
    $select = "SELECT * FROM `admins` WHERE `id` = '{$_SESSION['adminId']}'";
...
//     $searched = true ;
//     $search =$_POST['search'];
//     $select_search = "SELECT * FROM `admins` WHERE `firstname`LIKE '%$search%'";
...
<?php foreach ($run_select as $record) { ?>
  ...
  <td><?php echo $record['phone'];?></td>
    ...
    <td >
      ...
      <a class="btn btn-dark badge-pill " href="/easy kayaking graduatiopn project/admin/updateAdminData.php?editt=<?php echo $record['id'];?>"> Update</a>
