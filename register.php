...
if(isset($_POST['register']))
{
    ...
    if(mysqli_num_rows($runSelect) > 0){
      ...
      echo"username should only contain letters, numbers and underscores";
    } elseif(empty($email)){
    ...
    } elseif($phone < 11){  //01022271062
      echo"phone number should be more than 11 charachters";
    } else {
      // Hash the password and confirm password using password_hash()
      $hashedPassword = password_hash($password, PASSWORD_DEFAULT);
    //   $hashedConfirmPassword = password_hash($confirmPassword, PASSWORD_DEFAULT);
      
      // Insert the encrypted password and confirm password into the database
      $insertQuery = "INSERT INTO `user` 
      VALUES ( NULL ,'$userName','$email','$hashedPassword','$phone','NO')";
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" enctype="multipart/form-data" method="POST" >
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text"  name="username" class="form-control form-control-user" id="name"
                                            placeholder="Name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="password"  name="confirmpass" class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="confirmpasword">
                                    </div>
                                </div>
                                ...
                                <input type="submit" value="register" name="register" class="btn btn-success btn-user btn-block">
                            ...
                            <hr>
                                    <div class="text-center">
                                        <a class="small" href="login.php">Have An Account? Login Now!</a>
                                    </div>
                        </div>
                    </div>
                </div>
